...
<!-- ********************************************|1 CONTENIDO |*******************************************************************************************************************-->
    ...
    <div class="container-fluid">
        <div class="row"> <!--row: se utiliza para definir una tabla de posicionamiento donde utilizar despues las clases Col-xs-?  -->
            ...
            <!--Centro de pagina -->
            <div class="col-xl-6" style="margin-top:20px;border-left:dotted black 1px;border-right:dotted black 1px;border-top:dotted black 1px;background:lightblue;">
